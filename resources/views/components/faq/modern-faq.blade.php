...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600">Got questions? We've got answers</p>
        </div>

        <div class="max-w-4xl mx-auto">
            <div class="space-y-6">
                <!-- FAQ Item 1 -->
                <div class="bg-white rounded-xl p-6 border border-gray-100 hover:border-blue-100 transition-colors">
                    <button class="flex justify-between items-center w-full text-left focus:outline-none" onclick="toggleFAQ('faq1')">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 text-xs text-gray-400">Click to expand</span>
                        </div>
                    </button>
